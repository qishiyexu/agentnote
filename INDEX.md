...
- [2026-07-11 为 ThorTerminal 测试台增加重连任务、画面和资源曲线](./sessions/2026-07-11-add-thor-terminal-test-bench-task-previews.md) — 每个任务独占 Sidecar 进程，曲线带坐标、可调时间跨度和平均值；切换页面后任务仍继续并可恢复显示。
