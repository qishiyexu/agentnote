...
- [2026-07-11 为 ThorTerminal 测试台增加重连任务、画面和资源曲线](./sessions/2026-07-11-add-thor-terminal-test-bench-task-previews.md) — 每个任务独占 Sidecar 进程并显示独立指标，连接持续时间填任意正数都可启动。
