...
- [2026-07-11 为 ThorTerminal 测试台增加重连任务、画面和资源曲线](./sessions/2026-07-11-add-thor-terminal-test-bench-task-previews.md) — 每个任务独占 Sidecar 进程，并显示各自的虚机画面、PID、CPU、内存和 I/O 曲线。
