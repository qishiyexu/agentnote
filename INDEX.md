...
- [2026-07-11 为 ThorTerminal 测试台增加重连任务、画面和资源曲线](./sessions/2026-07-11-add-thor-terminal-test-bench-task-previews.md) — 每个任务独占 Sidecar 进程，曲线支持最长 1 小时跨度；可选在连接期间打开独立实时画面窗口，断开后自动关闭。
